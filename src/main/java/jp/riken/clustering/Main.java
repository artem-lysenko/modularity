...
public class Main {
	...
	public static final void main(String[] args) {
		...
		if (displayUsage) {
			...
			System.out.println("\t(5)[optional] put in 'experimental' word as argument in the last position for density tree to be cut at the highest density edges rather than the lowest ones.");
